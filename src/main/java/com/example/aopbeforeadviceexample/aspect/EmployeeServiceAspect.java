package com.example.aopbeforeadviceexample.aspect;
...
public class EmployeeServiceAspect {
	@Before(value = "execution(* com.example.aopbeforeadviceexample.service.EmployeeService.*(..)) and args(empId, fname, sname)")  
